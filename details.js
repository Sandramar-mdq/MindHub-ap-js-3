    ...
    return`
          <div class="card c-div" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <p class="c-body">${assistance} </p>            
                <a href="#" class="c-btn c-btn:hover">Price: ${dato.price} </a>
                <a href="./details.html?_id=${dato._id}" class="c-btn c-btn:hover">Details</a>
              </div>
            </div>
          </div>
        </div>
...
function printDetail(id, dat, array_data){
  let container = document.querySelector(id)
  dat = array_data.find(each => each._id === dat)
  let details = defineDetail(dat)
  container.innerHTML = details
}

printDetail(`#cards-container` , id_query, data)